...
export default function About() {
  ...
  const techStack = [
    ...
    { name: "TypeScript", icon: <Zap className="w-5 h-5" />, description: "Type-safe development" },
      ...
      <div className="max-w-6xl mx-auto px-4 space-y-12">
        ...
        <div className="text-center space-y-6">
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <h1 className="text-5xl md:text-6xl font-bold bg-gradient-dream bg-clip-text text-transparent">
