...
export default function Profile() {
  ...
  const tabs = [
    ...
    { id: "api", label: "API Keys", icon: Key, color: "text-orange-400" }
  ];
                    ...
                    <div key={key} className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          ...
                          {key === "dreamsPublic" && "Allow others to view your public dream gallery"}
                          {key === "allowPrivateDreams" && "Enable private dream creation (only you can see them)"}
